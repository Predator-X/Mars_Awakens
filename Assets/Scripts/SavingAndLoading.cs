...
public class SavingAndLoading : MonoBehaviour
{
   ...
   public GameObject numberOfPlayersText;
    ...
    //Converting to multiplayer------------------------!!!!!!!!!!!!!! this is no longer in use Delete if not used at the end of the development!!!!!!!!!!!!!!!!!
    ...
    IEnumerator LoadAsynchronously(int sceneIdnex)
    {
        ...
        if (operation.isDone)
        {
            ...
            if (!isLoadingMenu && !isLoadingNextLevel && isSceneFromSaveOrAreadyPlayed)
            {
               ...
               // this.GetComponent<SavingAndLoading>().LoadPlayer(); <-------------- Not in use since project rework
            ...
            if (!isSceneFromSaveOrAreadyPlayed && !isLoadingMenu && !isLoadingNextLevel)
            {/* --------NOT IN USE SINCE PROJECT REWORK-----------------------
